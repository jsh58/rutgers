...
def findDupsSE(fOut, readsSE, repSE, scoreSE):
  ...
  sys.stderr.write('SE-aligned fragments:%11d\n' % len(readsSE))
  dups = 0
...
def processSAM(f, fOut):
  ...
  sys.stderr.write('Total SAM records:%14d\n' % count \
    + '  Unmapped:%21d\n' % unmap)
